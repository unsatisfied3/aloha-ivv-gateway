      ...
      <div className="min-h-screen flex w-full">
        ...
        <div className="flex-1 flex flex-col">
          ...
          <main className="flex-1 p-8 bg-muted/30">
              ...
              <CardContent className="space-y-6">
                ...
                <div>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 ml-7">
                    ...
                    <div>
                      <p className="text-sm text-muted-foreground">Current Projected End</p>
                      <p className={cn("font-medium", scheduleDelayDays > 0 && "text-red-600")}>
                        {format(new Date(project.currentProjectedEndDate), "MMM dd, yyyy")}
                      </p>
                      {scheduleDelayDays > 0 && (
                        <Badge className="text-xs bg-red-500/20 text-red-700 border-red-500/30 mt-1">
            ...
            {/* Section 2: Reports for This Project */}
            <Card className="mb-8">
              <CardHeader>
